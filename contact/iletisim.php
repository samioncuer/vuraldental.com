        ...
        <div class="page-banner-area">
            <div class="container">
                <div class="page-banner-content">
                    ...
                    <ul class="pages-list">
                        <li><a href="../index.htmlindex.html">Anasayfa</a></li>
                        <li>İletişim</li>
                    </ul>
                </div>
            </div>
                ...
                <div class="contact-form">
                    <form action="iletisim.php?islem" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="email" id="eposta" name="eposta" class="form-control" required data-error="Lütfen E-posta Adresinizi Giriniz" placeholder="E-posta">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <!-- <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" id="phone" name="phone" required data-error="Lütfen Telefon Numaranızı Giriniz" class="form-control" placeholder="Telefon">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div> -->
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" id="konu" name="konu" class="form-control" required data-error="Lütfen Bir Konu Giriniz" placeholder="Konu">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <textarea id="mesaj" name="mesaj" class="form-control" cols="30" rows="5" required data-error="Lütfen Mesaj Kısmını Doldurunuz" placeholder="Mesaj"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
