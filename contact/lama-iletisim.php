                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="contact-us.html" class="nav-link active">İletişim</a>
                                </li>
                            </ul>
        ...
        <section class="contact-area ptb-100">
            <div class="container">
                <div class="section-title">
                    ...
                    <h2>Uzman Hekimlerimizle Hemen İletişime Geçin!</h2>
                </div>
                    ...
                    <form  action="iletisim.php?islem" method="post">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="isim" class="form-control" required data-error="Lütfen İsminizi Giriniz" placeholder="İsim">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="email" name="eposta" class="form-control" required data-error="Lütfen E-posta Adresinizi Giriniz" placeholder="E-posta">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="phone" required data-error="Lütfen Telefon Numaranızı Giriniz" class="form-control" placeholder="Telefon">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <input type="text" name="konu" class="form-control" required data-error="Lütfen Bir Konu Giriniz" placeholder="Konu">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <textarea name="mesaj" class="form-control" cols="30" rows="5" required data-error="Lütfen Mesaj Kısmını Doldurunuz" placeholder="Mesaj"></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        ...
                        <?php
                            ...
                            if (isset($_GET['islem'])) {
                                ...
                                if ($_POST['eposta']<>'' && $_POST['isim']<>'' && $_POST['konu']<>'' && $_POST['mesaj']<>''&& $_POST['phone']<>'') {
                                ...
                                $mail->From = "sami.oncuer2@gmail.com";
                                $mail->Fromname = $_POST['isim'];
                                $mail->AddAddress("sami.oncuer2@gmail.com","Mail gönderimi");
                                $mail->Subject = $_POST['konu'] . $_POST['eposta'].$_POST['phone'];
                ...
                <div class="contact-info">
                    <div class="contact-info-content">
                        <h3>Arayarak veya e-posta göndererek bize ulaşabilirsiniz</h3>
                        <h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <p>
                                ...
                                ve 8 yıllık klinik<br>
                                tecrübelerimizi aktardığımız<br>
                                “Vural Dental”de<br>
                                2021 eylül ayında hizmete başladık.
                            </p>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <ul class="footer-information list-group">
                                <li>
                                    <i class="flaticon-emergency-call"></i>
                                    Hemen Arayın!
                                    <span><a href="tel:088123654987">+088 123 654 987</a></span>
                                ...
                                <li>
                                    ...
                                    Adres
                                    <span>Halaskargazi mah.<br> Halaskargazi cad.<br>  No:38-66 Daire:29<br>  ŞİŞLİ / İSTANBUL</span>
                                </li>
                            </ul>
                        </div>
                    </div>
